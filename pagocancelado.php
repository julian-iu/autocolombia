    ...
    if ($accion == 'buscar') {
        ...
        if ($placa != "" && $mes != "MES" && $ano != "") { // buscar ano y mes
            ...
            if ($cantidad == 0) {
                ...
                $v_id = $datovh['v_id'];
                $sqlconsulta = "SELECT * FROM parqueo, vehiculo, celda WHERE p_vehiculoFK = v_id AND p_celdaFK = c_id  AND MONTH(p_fechasalida) = " . $mes . " AND YEAR(p_fechasalida) = " . $ano . " AND p_estado = '2' AND  p_vehiculoFK  = " . $v_id . " AND p_pago = '1' ";
        ...
        include_once 'parqueocancelar.php';
    }
}
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form ROLE="FORM" METHOD="POST" ACTION="">
                                                ...
                                                <h5>¿Desea eliminar el pago del mes correspondiente al vehiculo de placa <?php echo  $vehiculo; ?> del mes <?php echo htmlspecialchars(string: isset($_SESSION['mes']) ? $_SESSION['mes'] : ''); ?> año <?php echo htmlspecialchars(string: isset($_SESSION['ano']) ? $_SESSION['ano'] : ''); ?></h5>
